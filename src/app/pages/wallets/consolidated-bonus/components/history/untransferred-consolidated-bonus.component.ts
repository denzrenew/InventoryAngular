...
@Component({
  selector: 'app-untransferred-consolidated-bonus-wallet',
  templateUrl: './untransferred-consolidated-bonus.component.html',
  styleUrls: ['./untransferred-consolidated-bonus.component.scss']
})
export class UntransferredConsolidatedBonusWalletComponent implements OnInit {
  ...
  protected loadData(): void {
    ...
    this.walletService.getUntransferredConsolidationMonthlyRewardByUserId(
